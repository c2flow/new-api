...
func GetUserTopUps(c *gin.Context) {
	...
	topups, total, err := model.GetScopedTopUps(model.ResourceScope{OrgID: c.GetInt("org_id"), UserID: c.GetInt("id"), AllMembers: c.GetInt("org_id") > 0}, c.Query("keyword"), pageInfo)
	if err != nil {
